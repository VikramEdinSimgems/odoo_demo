...
class View(models.Model):
    ...
    def _get_view_info(self):
        return {
            ...
            # 'cohort': {'icon': 'fa fa-chart-line'},  # Added cohort view
            # 'gantt': {'icon': 'fa fa-tasks'},  # Added gantt view
            # 'grid': {'icon': 'fa fa-th'},  # Added grid view
            # 'map': {'icon': 'fa fa-map-marker'},  # 🔥 Add this to fix KeyError: 'map'
        }
